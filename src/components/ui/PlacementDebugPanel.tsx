        ...
        <div className="w-80 rounded-lg border border-white/20 bg-black/90 p-4 text-white backdrop-blur-sm">
            ...
            {showPlacementOrientationDebug && (
              <div className="ml-6 mt-2 space-y-2">
                ...
                <div className="mt-2 rounded bg-gray-800 p-2 text-xs text-gray-500">
                  <p>
                    💡 Uses ArrowHelper.rotation for EXACT orientation matching
                  </p>
                  <p>
          ...
          {debugState.enabled && (
            <>
              ...
              <div className="mt-2 rounded bg-gray-800 p-2 text-xs text-gray-500">
                <p>
                  💡 Arrows show the &ldquo;up&rdquo; direction of placed
          ...
          <div className="mt-4 border-t border-gray-600 pt-3">
            <div className="space-y-2 text-xs text-gray-400">
              ...
              <p>
                • <span className="text-green-400">Green arrows</span> = Valid
                placement zones
              </p>
              <p>
                • <span className="text-red-400">Red arrows</span> = Invalid
                placement (collision/steep)
              </p>
              <p>
                • Arrows show the &ldquo;up&rdquo; direction objects will have
                when placed
              </p>
              {placementDebugShowComparison && (
                <p>
                  • <span className="text-red-400">Shorter red arrows</span> =
