...
export function Pig({
  ...
  useFrame((state) => {
    ...
    // Add subtle idle animation for pig
    if (selected) {
      groupRef.current.rotation.y = rotation[1] + Math.sin(state.clock.elapsedTime * 1.6) * 0.05;
    } else {
...
useGLTF.preload("/animals/pig.glb");
