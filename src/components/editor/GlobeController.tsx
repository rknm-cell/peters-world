...
export function GlobeController({ globeRef: _globeRef, children, enabled = true, onGroupRefReady }: GlobeControllerProps) {
  ...
  }, [enabled, gl.domElement, handlePointerDown, handlePointerMove, handlePointerUp]);
